...
const EventContainer = styled.div`
  ...
  align-items: center;
  border-bottom: ${(props) =>
    !props.visuallyImpairedModeWhiteTheme
      ? "1px solid white"
      : (props) => (props.visuallyImpairedMode ? "1px solid" : "unset")};
  background: transparent;
  box-shadow: ${(props) =>
    props.visuallyImpairedMode
      ? "unset"
      : "0px 0px 20px rgba(29, 29, 27, 0.2)"};
  border-radius: ${(props) => (props.visuallyImpairedMode ? "unset" : "28px")};
  color: ${(props) =>
    !props.visuallyImpairedModeWhiteTheme ? "white" : "black"};
  position: relative;
  cursor: pointer;
...
const Text = styled.p`
  ...
  padding: ${(props) =>
    props.visuallyImpairedMode ? "unset" : "50px 20px 20px 20px"};
  margin-right: ${(props) => (props.visuallyImpairedMode ? "30px" : "unset")};
  @media screen and (max-width: 1300px) {
    padding: ${(props) =>
      props.visuallyImpairedMode ? "unset" : "30px 20px 20px 20px"};
  }
  @media screen and ${device.mobileL} {
...
export default function Event({
  ...
  return (
    <EventContainer
      visuallyImpairedModeWhiteTheme={visuallyImpairedModeWhiteTheme}
    ...
    >
      ...
      >
        <TextField fontSize="40px !important" fontWeight="bold">
          {inputDate.getDate()}
        </TextField>
        <MonthAndDay visuallyImpairedMode={visuallyImpairedMode}>
          ...
          >
            {firstChartToUpperCase(
              format(inputDate, "MMMM yyyy", {
                locale: locale === "EN" ? enGB : locale === "RU" ? ru : uk,
              })
            )}
          </TextField>
          <TextField fontSize="16px" fontWeight="100">
            {renderDay()}
          </TextField>
        </MonthAndDay>
      ...
      <Text
        visuallyImpairedMode={visuallyImpairedMode}
        border={offBorder ? "unset" : "1px solid"}
      >
        {hoursOne?.title}
      </Text>
