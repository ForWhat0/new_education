...
export const StyledRegisterZNO = ({
  databaseId,
  showZNORegister,
  contacts,
  menu,
  ...
  return (
    <Container
      ...
      align={align}
    >
      <Title>{showZNORegister.title}</Title>
      <ContainerWrapper>
        <TextZno>
          <IconBackgroundZNO
            background={
              !visuallyImpairedModeWhiteTheme
                ? "leftCommentZnoWhiteicon.svg"
                : "registerZnoIcon.svg"
            }
          />
          <SubTitle>{leftCommentZno.writeUs[locale]}</SubTitle>
        </TextZno>
        <InputsFields>
          <Flex>
            <InputStyled
              maxlength="20"
              warning={emptyFieldWarning}
              value={name}
              text={leftCommentZno.name[locale]}
            ...
            <InputStyled
              ...
              value={phone}
              text={leftCommentZno.phoneNumber[locale]}
          ...
          <InputStyled
            ...
            value={email}
            maxlength="40"
            text={leftCommentZno.email[locale]}
          ...
          <InputStyled
            ...
            value={comment}
            maxlength="100"
            text={leftCommentZno.comment[locale]}
