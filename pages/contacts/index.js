        ...
        <Content>
          <Info>
            ...
            <FieldTextIcon
              ...
              content={contacts?.phoneNumber ? contacts.phoneNumber : null}
            />
            <FieldTextIcon
              icon="/mapIcon.svg"
              title={contactsLsi.adress[locale]}
              content={contacts?.adress ? contacts.adress : null}
            />
            <FieldTextIcon
              icon="/gmailIcon.svg"
              title={contactsLsi.email[locale]}
              content={contacts?.gmail ? contacts.gmail : null}
            />
            <Field>
              <a
          ...
          <MapCenter>
            ...
            >
              ...
              <a
                ...
                target="_blank"
              >
                <span>{contactsLsi.map[locale]}</span>
              </a>
            </MapContainer>
          </MapCenter>
        </Content>
